...
?>
<div class="col-md-12">
<div id="psot-profile" class="bx-auth-profile table-responsive">
...
<table class="data-table profile-table">
	...
	<p><input class="btn-zakaz nav-link btn btn-primary my-2 my-sm-0 btn-profile" type="submit" name="save" value="<?=(($arResult["ID"]>0) ? GetMessage("MAIN_SAVE") : GetMessage("MAIN_ADD"))?>">&nbsp;&nbsp;<input class="btn-zakaz nav-link btn btn-primary my-2 my-sm-0 btn-profile" type="reset" value="<?=GetMessage('MAIN_RESET');?>"></p>
</form>
<?/*
